...
## only python3
iPATH=$iPATH:"$BREWHOME/opt/python@3.11/bin" # make soft links('ln -s') python3 & pip3 from the specific version
export PYTHONPATH=`uniq_csv "$BREWHOME/lib/python3.11/site-packages:$PYTHONPATH"`
