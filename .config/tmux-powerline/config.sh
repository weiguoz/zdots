...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="my_base16"
...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/vm/_06_c4ln7k16t3qz1g8xp9l00000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/weiguo/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/weiguo/.mailcheckrc"
# }
