...
function SetTitle()
  ...
  if ft == 'sh' or ft == 'python' then
    ...
    vim.api.nvim_buf_set_lines(0, 2, 2, false, {"# " .. vim.fn.expand("$USER") .. " created " .. vim.fn.expand("%") .. " at " .. vim.fn.strftime("%F %R")})
  ...
  elseif ft == 'c' or ft == 'cpp' then
    ...
    vim.api.nvim_buf_set_lines(0, 1, 1, false, {" * " .. vim.fn.expand("$USER") .. " created " .. vim.fn.expand("%") .. " at " .. vim.fn.strftime("%F %R")})
